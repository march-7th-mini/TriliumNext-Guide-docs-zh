...
*   Support for ELK layout in Mermaid diagrams (sponsored by @perfectra1n). See <a class="reference-link" href="#root/pOsGYCXsbNQG/KSZ04uQ2D1St/s1aBHPd79XYj/RH6yLjjWJHof">ELK layout</a> for more information.
